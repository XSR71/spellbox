...
window.onload = function(){
    ...
    core.onload = function(){
        ...
        core.rootScene.on('abuttondown', function() {
            status.add('abuttondown');
        });
        core.rootScene.on('abuttonup', function() {
            status.add('abuttonup');
        });

        core.rootScene.on('bbuttondown', function() {
            status.add('bbuttondown');
        });
        core.rootScene.on('bbuttonup', function() {
            status.add('bbuttonup');
        });
